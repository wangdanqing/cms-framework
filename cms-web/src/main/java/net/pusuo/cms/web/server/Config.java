...
import net.pusuo.cms.web.server.util.Duration;
import net.pusuo.cms.web.server.util.Size;
...
public class Config {
    ...
    public int min_thread = 5;
    public int max_thread = 15;
    //default http config
    ...
    public final static Duration maxIdleTime = Duration.seconds(10);
    ...
    public final static int acceptorThreads = Runtime.getRuntime().availableProcessors() - 1;
    ...
    public final static int acceptQueueSize = 100;
    ...
    public final static Size requestBufferSize = Size.kilobytes(8);
    public final static Size requestHeaderBufferSize = Size.kilobytes(2);
    public final static Size responseBufferSize = Size.kilobytes(16);
    public final static Size responseHeaderBufferSize = Size.kilobytes(1);
    ...
    public final static String DEFAULT_TEMPLATE_FOLDER = "webapp/WEB-INF/vm/";
