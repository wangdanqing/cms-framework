...
public class ServerFile extends UnicastRemoteObject implements FileInterface {
    ...
    private ServerFile() throws Exception, RemoteException {
        pageroot = Configuration.getInstance().get("cms4.file.page.root");
        syncpageroot = Configuration.getInstance().get("cms4.file.sync.dir");
    }
