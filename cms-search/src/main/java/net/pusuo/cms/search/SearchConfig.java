...
import net.pusuo.cms.search.util.XMLProperties;
...
public class SearchConfig {
    ...
    private static final String SEARCH_CONFIG_FILENAME = "search_config.xml";
    ...
    public static String getHome() {
        if (HOME == null) {
            HOME = PropertyManager.getProperty("Search.home");

            // If HOME is still null, try loading it as a system property
            if (HOME == null) {
                HOME = System.getProperty("SEARCH_HOME");
            }
        }
        return HOME;
    }
    ...
    private synchronized static void loadProperties() {
        if (properties == null) {
            ...
            try {
                ...
                if (HOME != null) {
                    properties = new XMLProperties(HOME + File.separator + SEARCH_CONFIG_FILENAME);
                }
